/*
 * FILE: ChessForm.cs
 * PURPOSE: This is the main game window that orchestrates everything. It acts as a Mediator between the ChessEngine (logic), ChessBoardControl (visuals), and the timers/history. It holds everything together and ensures components don't talk to each other directly, which is a key OOP concept.
