/*
 * FILE: CapturedPiecesControl.cs
 * PURPOSE: This control visually displays the pieces that each player has captured. It calculates the material advantage and draws the captured piece symbols overlapping each other.
