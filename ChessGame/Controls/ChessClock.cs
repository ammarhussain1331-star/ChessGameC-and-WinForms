/*
 * FILE: ChessClock.cs
 * PURPOSE: This control manages the dual countdown timers for both players. It uses a System.Windows.Forms.Timer to accurately tick down time and raises an event when a player's time expires.
