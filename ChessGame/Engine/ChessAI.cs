/*
 * FILE: ChessAI.cs
 * PURPOSE: This file implements the artificial intelligence for the computer opponent. It uses the Minimax algorithm with Alpha-Beta pruning to evaluate future moves efficiently. We run this on a background thread (Task.Run) so the UI doesn't freeze while the computer is 'thinking'.
