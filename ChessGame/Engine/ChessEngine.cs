/*
 * FILE: ChessEngine.cs
 * PURPOSE: This file contains the core logic of the chess game. It handles move validation, piece movement rules, check/checkmate detection, and board state management. We separated this from the UI to follow the MVC (Model-View-Controller) and Mediator design patterns, making the code cleaner and easier to maintain.
